...
// Permission-based authentication check - allows staff with permissions
...
// User management permission check - allows staff with users permission
export async function requireUserManagement(req) {
  return requirePermission(req, "users");
}
